    ...
    <div class="sub_header">
      <div class="container">
          <div class="row header_top">
              <div class="col-6 col-sm-6 col-md-6" style="text-align:start">
                  <div class="w-100">
              ...
              <div class="col-6 col-sm-6 col-md-6" style="text-align:end">
                  <div class="w-100">
                      <router-link :to="'/aloqa'" class="w-100"><a href="#"><span><img src="@/assets/call1.png"> +99895 401-20-21</span></a></router-link>
                  </div>
              </div>
          </div>
      </div>
      ...
      <div class="container">
        <div class="row d-flex sub_header_row">
          <div class="col-3 col-md-3 p-0 bac_img">
            <router-link class="w-100" :to="'/forusers'"><img src="@/assets/logohead.png"></router-link>
          </div>
          ...
          <div class="p-0 col-9 col-md-2 karzina_icons">
            <div class="karzina_user w-100">
              <div class="box1">
                <router-link class="asasa" :to="'/savat/0'"><img src="@/assets/karzina.png" alt="png"></router-link>
              </div>
              <div class="box2" @click="show_hede">
                <a href="#"><img src="@/assets/user.png" alt="png"></a>
                <drop-down v-if="show_hide" class="dropdown" />
              </div>
            </div>
          </div>
        </div>
