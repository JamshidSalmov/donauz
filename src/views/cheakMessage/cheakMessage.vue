                        ...
                        <form class="forms">
                            ...
                            <div class="password">
                                <div class="pass_input">
                                    <input :type="passwordType" id="parol" class="inputt passwordicon w-100 m-0" placeholder="Parol" v-model="password">
                            ...
                            <div class="buttonss">
                                <button @click="passMainPage" class="btnn">Yuborish</button>
                            </div>
                        </form>
                    </div>
                 </div>
...
export default {
    ...
    methods: {
        ...
        passMainPage(){
            ...
            if(this.message_cod==this.password){
