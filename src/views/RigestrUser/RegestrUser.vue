            ...
            <div class="box">
                 <div class="boxx">
                     ...
                     <div class="box_paragrf">
                         <p>Parol va Telefon raqamingizni kiriting</p>
                    </div>
                    <div class="box_form">
                        <form class="forms">
                            <div class="loginn">
                                <input type="text" id="login" class="inputt" placeholder="+998 9* *** ** **" v-model="login">
                                <small class="text-danger mt-0" style="margin-left:5px; "  v-if="$v.login.$dirty && !$v.login.required">Enter Your Login</small>
                                <small class="text-danger mt-0" style="margin-left:5px; "  v-if="$v.login.$dirty && !$v.login.minLength">Login must have at least {{ $v.login.$params.minLength.min }} letters.</small>
                            </div>
                            <div class="password">
                            ...
                            <div class="buttonss">
                                <button @click="cheakMessage" class="btnn">Yuborish</button>
                            </div>
                        </form>
                    </div>
                 </div>
